  ...
  const handleProcessImage = () => {
    ...
    fetch('http://127.0.0.1:5000/upload', {
      ...
      .then((data) => {
        ...
        setLoading(false);
        setMessages((prevMessages) => [...prevMessages, { sender: 'bot', text: `Detected Deficiency: ${data.label}` }, { sender: 'bot', text: `${data.info}` }]);
      })
      .catch((error) => {
...
return (
  ...
  <div className="container mt-5">
    ...
    <div className="app-body d-flex">
      ...
      <h1><strong>Nutrient Deficiency Detection</strong></h1>
      <p>Leaf It to Us! 🍃 Upload Your Rice crop leaf Pic Now! 📸 We'll identify and tell you all there is to know about it.</p>
        ...
        {detectedLabel && (
          <div className="mt-2">
            <strong>Detected Deficiency:</strong> {detectedLabel}
          </div>
        )}
      </div>
