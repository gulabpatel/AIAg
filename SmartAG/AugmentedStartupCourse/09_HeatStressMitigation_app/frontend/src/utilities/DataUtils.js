// groupBy: Groups an array of objects by a specified key and returns an object with key-value pairs. 
// The value is an array of objects, excluding the key used for grouping.
...
// getAverage: Calculates the average of a given array. If isRound is true, the result is rounded.
// Otherwise, it's fixed to two decimal places.
...
// getMostFrequentWeather: Determines the most frequent value in an array.
// Useful for finding the most common weather condition in a list of weather data.
...
// descriptionToIconName: Maps a weather description to its corresponding icon name.
// Uses a provided list of descriptions and icons.
...
// getWeekForecastWeather: Processes weather forecast data for a week.
// It groups data by date, calculates average values, and determines the most frequent weather conditions.
...
// getTodayForecastWeather: Processes weather forecast data specifically for the current day.
// Filters and formats data for today's date and time.
